...
<div class="bannerWrap">
    ...
    <div>
        ...
        <h2 class="wow fadeInDown" data-wow-delay="0.3s">한마음컴퍼니</h2>
        <p class="wow fadeInDown" data-wow-delay="0.6s">한마음컴퍼니는 고객들의 의견을 존중하고<span>획기적인 기획과 저가격으로 최고의 효과로 마케팅을 합니다.</span></p>
...
<div class="aboutWrap">
   <div class="box inner">
        <div class="main_title">
            ...
            <p class="wow fadeInDown" data-wow-delay="0.4s">저희 한마음컴퍼니는 고객에게 만족을 드리기 위해 지난 수년간의 노력과 수차례의 시행착오를 통해 고객님들과 함께 성장해왔습니다. 수많은 경험을 바탕으로 고객의 요구에 적합한 마케팅을 제작합니다. 항상 신뢰받는 기업, 끊임없이 개발하는 기업, 투명한 기업을 이루도록 최선을 다하겠습니다.</p>
        </div>
        <div class="detail">
            <ul class="clearfix">
...
<div class="coreComWrap">
   <div class="box inner">
        <div class="main_title">
            ...
            <p class="wow fadeInDown" data-wow-delay="0.4s">앞서가는 트랜드와 끊임없이 발전해가는 한마음컴퍼니입니다.</p>
        </div>
        <div class="detail">
            <ul class="clearfix">
...
<div class="portfolioWrap">
    <div class="inner">
        <div class="main_title">
            ...
            <p class="wow fadeInDown" data-wow-delay="0.4s">앞서가는 트렌드와 끊임없이 발전해가는 한마음컴퍼니입니다.</p>
        </div>
...
<div class="contactWrap">
    <div class="box inner">
        <div class="main_title">
            ...
            <p class="wow fadeInDown" data-wow-delay="0.4s">한마음컴퍼니로 찾아오시는 길을 안내해드립니다.</p>
        </div>
        <div class="detail">
